...
#[repr(C)] //ensured our struct has a predictable memory layout, crucial for onchain data
pub struct Escrow {
...
impl Escrow {
    ...
    pub fn load_mut(bytes: &mut [u8]) -> Result<&mut Self, ProgramError> {
        ...
        //borrow is safe now, to use unsafe method
    ...
    pub fn load(bytes: &[u8]) -> Result<&Self, ProgramError> {
        ...
        //bytes is validated, and safe to use unsafe
    ...
    #[inline(always)]
    pub fn set_recieve(&mut self, receive: u64) {
